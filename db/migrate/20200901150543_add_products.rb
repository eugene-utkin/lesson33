class AddProducts < ActiveRecord::Migration[6.0]
  def change
	...
	Product.create :title => 'Vagetarian', :description => 'Amazing Vegetarian pizza!', :price => 400, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => false, :path_to_image => '/images/veg.jpg'
  end
end
